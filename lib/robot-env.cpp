    ...
    else
    {
        switch (cro->color)
        {
          case 0:
            cro->rgbcolor[0] = 0.0;
            cro->rgbcolor[1] = 0.0;
            cro->rgbcolor[2] = 0.0; // black
            break;
          case 1:
            cro->rgbcolor[0] = 1.0;
            cro->rgbcolor[1] = 0.0;
            cro->rgbcolor[2] = 0.0; // red
            break;
          case 2:
            cro->rgbcolor[0] = 0.0;
            cro->rgbcolor[1] = 1.0;
            cro->rgbcolor[2] = 0.0; // green
            break;
          case 3:
            cro->rgbcolor[0] = 0.0;
            cro->rgbcolor[1] = 0.0;
            cro->rgbcolor[2] = 1.0; // blue
            break;
          case 4:
            cro->rgbcolor[0] = 0.0;
            cro->rgbcolor[1] = 1.0;
            cro->rgbcolor[2] = 1.0; // cyan
            break;
          case 5:
            cro->rgbcolor[0] = 1.0;
            cro->rgbcolor[1] = 0.0;
            cro->rgbcolor[2] = 1.0; // pink
            break;
          case 6:
            cro->rgbcolor[0] = 1.0;
            cro->rgbcolor[1] = 1.0;
            cro->rgbcolor[2] = 0.0; // yellow
            break;
          case 7:
            cro->rgbcolor[0] = 1.0;
            cro->rgbcolor[1] = 1.0;
            cro->rgbcolor[2] = 1.0; // white
            break;
          case 8:
            cro->rgbcolor[0] = 1.0;
            cro->rgbcolor[1] = 0.33;
            cro->rgbcolor[2] = 0.0; // orange
            break;
          case 9:
            cro->rgbcolor[0] = 0.5;
            cro->rgbcolor[1] = 0.25;
            cro->rgbcolor[2] = 0.0; // brown
            break;
          case 10:
            cro->rgbcolor[0] = 0.0;
            cro->rgbcolor[1] = 0.5;
            cro->rgbcolor[2] = 0.75; // light blue
            break;
          case 11:
            cro->rgbcolor[0] = 0.5;
            cro->rgbcolor[1] = 0.5;
            cro->rgbcolor[2] = 0.5; // gray
            break;
          case 12:
            cro->rgbcolor[0] = 0.0;
            cro->rgbcolor[1] = 0.33;
            cro->rgbcolor[2] = 0.0; // dark green
            break;
          case 13:
            cro->rgbcolor[0] = 0.33;
            cro->rgbcolor[1] = 0.0;
            cro->rgbcolor[2] = 0.0; // dark red
            break;
          case 14:
            cro->rgbcolor[0] = 0.25;
            cro->rgbcolor[1] = 0.0;
            cro->rgbcolor[2] = 0.5; // violet
            break;
          case 15:
            cro->rgbcolor[0] = 0.98;
            cro->rgbcolor[1] = 0.9;
            cro->rgbcolor[2] = 0.74; // cream
            break;
        }
    }
